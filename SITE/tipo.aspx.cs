...
public partial class tipo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dv = (DataView)sqlTodos.Select(DataSourceSelectArguments.Empty);


            lblTipo.Text = cripto.Decrypt(dv.Table.Rows[0]["nome_tipo"].ToString());
        }
        catch { }
    }
    ...
    public DataTable listarTudo()
    {
        ...
        listar = (DataView)sqlTodos.Select(DataSourceSelectArguments.Empty);
